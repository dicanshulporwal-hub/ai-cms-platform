...
const MODULES = [
  ...
  { moduleKey: 'content_importer', moduleName: 'AI Content Importer', category: 'AI', icon: 'Sparkles', routePath: '/ai/content-importer', isEnabledGlobally: true, isAdminVisible: true, isPublicEnabled: false, isTemplateAvailable: false, description: 'Word and public web-to-CMS draft generation with review-before-import workflow.', dependsOnJson: ['ai_providers', 'media'], permissionsJson: ['content_importer.view', 'content_importer.upload', 'content_importer.word_import', 'content_importer.web_import', 'content_importer.web_validate', 'content_importer.web_batch_import', 'content_importer.web_sitemap_import', 'content_importer.web_image_import', 'content_importer.extract', 'content_importer.ai_analyze', 'content_importer.review', 'content_importer.approve_item', 'content_importer.import_item', 'content_importer.import_bulk', 'content_importer.cancel_job', 'content_importer.delete_job', 'content_importer.rules.view', 'content_importer.rules.create', 'content_importer.rules.update', 'content_importer.rules.delete', 'content_importer.logs.view'], settingsJson: { maxBatchUrls: 10, maxSitemapUrls: 25, respectRobotsDefault: true, draftOnly: true } },
  ...
  // ═══════════════════════════════════════════════════════════════
  { moduleKey: 'faq', moduleName: 'FAQ', category: 'CONTENT', icon: 'HelpCircle', routePath: '/faqs', publicRoutePath: '/faqs', isEnabledGlobally: true, isAdminVisible: true, isPublicEnabled: true, isTemplateAvailable: true, description: 'Frequently Asked Questions management.' },
  ...
  { moduleKey: 'forms', moduleName: 'Form Builder', category: 'PUBLIC_ENGAGEMENT', icon: 'ClipboardList', routePath: '/forms', publicRoutePath: '/forms', isEnabledGlobally: true, isAdminVisible: true, isPublicEnabled: true, isTemplateAvailable: true, description: 'Dynamic form builder and submissions.' },
  ...
  { moduleKey: 'social_media', moduleName: 'Social Media Publishing', category: 'PUBLIC_ENGAGEMENT', icon: 'Share2', routePath: '/social-media', isEnabledGlobally: true, isAdminVisible: true, isPublicEnabled: false, isTemplateAvailable: true, description: 'Social account management and MVP social publishing workflow.' },
